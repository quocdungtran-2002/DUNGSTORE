...
<?php
    ...
    class product{
        ...
        public function update_product($product_id,$product_name,$product_code,$cartegory_id,$producttype_id,$product_quantity,$product_price,$product_price_new,$product_desc
        // ,$product_img,$product_img_desc
        ){
            $query = "UPDATE tbl_product SET  product_name = '$product_name' , product_code = '$product_code' , cartegory_id = '$cartegory_id' , producttype_id = '$producttype_id' , product_quantity = '$product_quantity' , product_price = '$product_price' , product_price_new = '$product_price_new' , product_desc = '$product_desc' 
